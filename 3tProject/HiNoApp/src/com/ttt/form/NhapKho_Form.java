...
public final class NhapKho_Form extends Form {
    ...
    public void initTable() {
        ...
        model.setColumnIdentifiers(new String[]{"id", "Mã PN", "Vị trí", "Loại xe", "S.Khung", "S.Máy", "S.Lượng", "Giá nhập",
            "Người nhập", "Ngày nhập", "Người sửa", "Ngày sửa"});
    }
    ...
    boolean checkNull() {
        ...
        try {
            ...
            if (txtGiaNhap.getText() == null || txtGiaNhap.getText().equalsIgnoreCase("")
                    && txtSoMay.getText() == null || txtSoMay.getText().equalsIgnoreCase("")
    ...
    void xoa() {
        ...
        if (listPN != null) {
            ...
            DialogHelper.alert(this, "Phiếu nhập " + txtPNK.getText() + " chưa có trong cơ sở dữ liệu. Vui lòng chọn phiếu nhập khác!");
        }
